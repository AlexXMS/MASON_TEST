...
//    }
    ...
    public void start() {
        ...
        createAgent(new MyAgent("agent1", "EXPLORER", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
        ...
        pos = this.generateRandomLocation();
        createAgent(new MyAgent("agent2", "TILE_COLLECTOR", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
        pos = this.generateRandomLocation();
        createAgent(new MyAgent("agent3", "TILE_COLLECTOR", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
        pos = this.generateRandomLocation();
        createAgent(new MyAgent("agent4", "TILE_COLLECTOR", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
